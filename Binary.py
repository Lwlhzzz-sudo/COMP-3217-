...
def random_forest():
    ...
    file_path = "C:\\Users\\lwlhzzz\\Desktop\\3217 -lab\\TrainingDataBinary.csv"
    ...
    recall = recall_score(y_test_split, predictions)
    f1 = f1_score(y_test_split, predictions)
...
def linear_regression():
    ...
    # recall = recall_score(y_test_split, predictions.round() )
    # f1 = f1_score(y_test_split, predictions.round())
...
test_data = pd.read_csv("C:\\Users\\lwlhzzz\\Desktop\\3217 -lab\\TestingDataBinary.csv", header=None)
...
result.to_csv("C:\\Users\\lwlhzzz\\Desktop\\3217 -lab\\TestingResultsBinary.csv", index=False, header=False)